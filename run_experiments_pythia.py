...
model = GPTNeoXForCausalLM.from_pretrained('EleutherAI/pythia-{}'.format(pythia_variant))
tokenizer = AutoTokenizer.from_pretrained('EleutherAI/pythia-{}'.format(pythia_variant))
...
if __name__ == "__main__":
    ...
    for prefix, lst in queries:
        fname = f"{savepath}/{prefix}_pythia-{pythia_variant}.npz"
